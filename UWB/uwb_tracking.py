import json
import time
from uwb_to_db import DataManager, SewioWebSocket
...
class WebSocket2Kafka(SewioWebSocket):
    def __init__(self, manager, api_key, socket_url, resource, kafka_server, kafka_port, kafka_topic):
...
def main():
    # DB 연결 설정 json
    config_file = "configs_tracking.json"
